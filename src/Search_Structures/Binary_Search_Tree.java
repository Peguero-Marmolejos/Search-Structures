...
/*
 * Inital code is from geeks for geeks
 */
class BinarySearchTree { 
 ...
 // i.e. rightmost leaf node 
    ...
    public static void main(String[] args) {
		...
		BinarySearchTree lex_tree1 = new BinarySearchTree();//BST in lexographical order
		BinarySearchTree freq_tree1 = new BinarySearchTree();//BST in order by word frequency
